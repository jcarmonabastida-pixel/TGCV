...
required = [
    ...
    (IMPACT_DIR / "D-OPS-24_CANDIDATE_POOL_EXPANSION_DISCOVERY_v0.4.md", "D-OPS-24 v0.4 protocol"),
...
if trace.exists():
    ...
    required_ids = {"TGCV-CORE-001","TR-131","RUST-DYN-1","RUST-DYN-2","D-OPS-21","D-OPS-22","D-OPS-23","D-OPS-24","TGCV-EXT-TCP-001","TGCV-EXT-VP-001","TGCV-EXT-RP-001","TGCV-EXT-ARM-001","TGCV-EXT-RII-001","TGCV-EXT-MOI-001","SCIENTIFIC-ASSET-REGISTRY","EXT-UPD-3.6","EXT-UPD-3.7","EXT-UPD-3.8","DOPS24-DISCOVERY-PROTOCOL-v0.2","DOPS24-DISCOVERY-PROTOCOL-v0.3","DOPS24-DISCOVERY-PROTOCOL-v0.4","DOPS24-DISCOVERY-EXECUTION-v0.1","DOPS24-F1-Q3-CORRECTION","DOPS24-DISCOVERY-SEARCH-v0.3","DOPS24-F1-Q3-GOV-CORRECTION","DOPS24-EXT-UPD-4.0","EXT-UPD-4.0","RMA-v1.5","RMA-v1.6","RMA-v1.7","RMA-current","STATUS","PROPAGATION-WORKFLOW","VALIDATOR"}
    missing = required_ids - ids
    if missing: errors.append("Traceability missing required assets: " + ", ".join(sorted(missing)))
    for asset_id, expected in {"RMA-v1.5":"HISTORICAL-SUPERSEDED","RMA-v1.6":"HISTORICAL-SUPERSEDED","RMA-v1.7":"CURRENT","DOPS24-DISCOVERY-PROTOCOL-v0.3":"FROZEN-HISTORICAL","DOPS24-DISCOVERY-PROTOCOL-v0.4":"DRAFT-FOR-PREFLIGHT","DOPS24-F1-Q3-CORRECTION":"CLOSED","DOPS24-DISCOVERY-SEARCH-v0.3":"STOPPED-GOVERNANCE-HOLD","EXT-UPD-3.8":"CLOSED-CONSISTENT","DOPS24-F1-Q3-GOV-CORRECTION":"CLOSED","DOPS24-EXT-UPD-4.0":"CLOSED","EXT-UPD-4.0":"OPEN"}.items():
...
print("RMA v1.7, current pointer, traceability, STATUS, claim matrix, scientific registry, D-OPS-24 v0.4 controls and EXT-UPD-4.0 propagation are structurally aligned.")
