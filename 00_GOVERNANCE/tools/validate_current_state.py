...
require_file(RMA_DIR / "TGCV_RMA_v0.7.md", "current RMA master v0.7")
require_file(RMA_DIR / "TGCV_RMA_traceability_v0.7.csv", "current RMA traceability v0.7")
...
if rma_current.exists():
    ...
    if "TGCV_RMA_v0.7.md" not in text:
        errors.append("RMA current pointer does not point to v0.7")
...
trace = RMA_DIR / "TGCV_RMA_traceability_v0.7.csv"
if trace.exists():
    ...
    required_assets = {
        ...
        "RMA-v0.7", "RMA-current", "STATUS", "PROPAGATION-WORKFLOW", "VALIDATOR"
    }
...
print("RMA v0.7, current pointer, traceability, STATUS, claim matrix, propagation impacts, ARM v0.1 and canonical external asset structure are structurally aligned.")
