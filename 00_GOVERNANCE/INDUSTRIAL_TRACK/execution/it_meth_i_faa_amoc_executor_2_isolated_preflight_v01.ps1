# IT-METH-I FAA AMOC — Executor-2 isolated preflight v0.1
...
$output = Join-Path $TransferRoot 'executor_2_isolation_preflight.json'
...
$checks.output_confined = Test-PathUnderRoot $output $TransferRoot
