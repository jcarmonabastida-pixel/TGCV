...
## Independent Reconstruction Transfer Instructions 001
...
Provide a deterministic transfer procedure for obtaining `R001` and `R002` without cross-contamination between the two reconstructions.
...
2. `IT-G1_AWSSUPPORT_EXECUTEEC2RESCUE_CASE_EVIDENCE_MANIFEST_FROZEN_001.md`
...
7. The evidence objects referenced by the frozen case evidence manifest.
