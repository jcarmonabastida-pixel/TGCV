# TGCV — Registro Maestro de Activos (RMA) v0.5

**Estado:** CURRENT / OPERATIVE  
**Fecha:** 2026-09-08  
**Predecesor:** `00_GOVERNANCE/rma/TGCV_RMA_v0.4.md`  
**Governance basis:** DR-044 + DR-045 + EXT-UPD-1R.4 + EXT-UPD-3.1 + EXT-UPD-3.2  
...
The Vision Paper, ARM and RII remain dependent current asset families pending their own controlled drafting/review. MOI remains reserved.
...
EXT-UPD-3.2 now propagates the current TCP v0.3 controlled draft without changing scientific claims, evidence levels or gate states.
