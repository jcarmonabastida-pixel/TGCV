# TGCV — Registro Maestro de Activos (RMA) v0.8

**Estado:** CURRENT / OPERATIVE  
**Fecha:** 2026-09-09  
**Predecesor:** `00_GOVERNANCE/rma/TGCV_RMA_v0.7.md`  
...
- `TGCV-EXT-RII-001` → `05_ASSETS/RII/` — identified-pending
- `TGCV-EXT-MOI-001` → `05_ASSETS/MOI/` — reserved; substantive creation deferred

### Current content state

RP v0.1, TCP v0.3 and Vision Paper v0.2 remain the current controlled drafts with no epistemic upgrade. ARM v0.1 is now the first substantive canonical ARM controlled draft and its propagation is closed consistently under EXT-UPD-3.4.
...
- Current traceability: `00_GOVERNANCE/rma/TGCV_RMA_traceability_v0.8.csv`

## 14. Current reconciliation status

**RMA v0.8 CURRENT / OPERATIVE — EXT-UPD-3.4 ARM propagation CLOSED / CONSISTENT.**

The ARM historical reconstruction is closed, ARM v0.1 is canonical, and its propagation obligations have been reconciled across RMA, pointer, traceability, STATUS, CHANGELOG, validator target and consistency closure.
