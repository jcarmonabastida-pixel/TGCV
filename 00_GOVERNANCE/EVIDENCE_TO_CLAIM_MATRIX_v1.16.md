# TGCV — Evidence-to-Claim Matrix — Current v1.16

**Status:** GOVERNANCE CONTROL ARTIFACT — CURRENT  
**Date:** 2026-09-18  
**Predecessor:** v1.15  
**Incremental governance update:** Enriches the C05 EV–Grid Minimum Demonstrator record into a complete GL-07 material expediente; supersedes the compressed v1.15 C05 section without changing claim status/level. C05 propagation remains limited to C02, C07, C08 and C16; C09 remains unchanged.
