...
The v1.9 update preserves the full evidence/claim structure of v1.8 and adds the C10C-001 empirical evidence record plus bounded propagation to C02, C07, C08, C11 and C16. The complete C10C-002 evidence record and its prior bounded propagation remain preserved. No C01–C16 status is upgraded by C10C-001. C08, C09 and C10 are not upgraded or positively supported by C10C-001. The TGCV Core remains unchanged.
