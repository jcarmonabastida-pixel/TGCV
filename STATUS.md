...
- Canonical current versions: RMA `v3.34`, Evidence→Claim Matrix `v1.3`, RMA traceability `v3.34`, governance operating principles `v0.1`.
- Matrix v1.3 already contains the substantive SWIM accessibility/trajectory evidence and the Rust ND-1/ND-2/ND-4 evidence; therefore no matrix version increment was required.
- RMA v3.34 and traceability v3.34 now consolidate both closures without reopening them.
