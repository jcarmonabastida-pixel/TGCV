"""N-R5.3 predictor dataset smoke conformance runner.
...
def main():
    m = load(GEN)
    checks = []
    train_in = CORPUS / "train_snapshots.jsonl"
    test_in = CORPUS / "test_snapshots.jsonl"
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        train_lines = train_in.read_text(encoding="utf-8").splitlines()[:64]
        test_lines = test_in.read_text(encoding="utf-8").splitlines()[:64]
