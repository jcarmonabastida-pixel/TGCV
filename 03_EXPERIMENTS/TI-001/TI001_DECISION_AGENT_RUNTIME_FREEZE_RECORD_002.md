...
The Provider 002 preflight is the current static/canonical preflight. The diagnostic provider identity above is recorded separately from the scientific provider. Scientific execution remains blocked pending explicit reauthorization.

**Scientific execution: NOT AUTHORIZED / BLOCKED PENDING REAUTHORIZATION**

No scientific decision was generated by this reconciliation. The 256-token diagnostic-provider change is not scientific evidence.
