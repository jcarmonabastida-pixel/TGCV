...
BRANCH="main"
CONTRACT_PATH="03_EXPERIMENTS/TI-001/TI001_V009_SCIENTIFIC_EXECUTION_CONTRACT_001.json"
RUNTIME_SPEC_PATH="03_EXPERIMENTS/TI-001/TI001_V009_SCIENTIFIC_RUNTIME_SPECIFICATION_001.md"
DIAG_RESULT_PATH="03_EXPERIMENTS/TI-001/TI001_V009_RUNTIME_DIAGNOSTIC_002_RESULT_001.json"
DIAG_PREFLIGHT_PATH="03_EXPERIMENTS/TI-001/TI001_V009_RUNTIME_DIAGNOSTIC_002_PREFLIGHT_RESULT_001.json"
FIXTURE_PATH="03_EXPERIMENTS/TI-001/generated/V008/TI001_V008_FIXTURE_001.json"
...
def main():
    ...
    a=p.parse_args()
    token=a.token
    files={x:gh(x,token) for x in [CONTRACT_PATH,RUNTIME_SPEC_PATH,DIAG_RESULT_PATH,DIAG_PREFLIGHT_PATH,FIXTURE_PATH]}
    contract=json.loads(__import__("base64").b64decode(files[CONTRACT_PATH]["content"]).decode())
    diag=json.loads(__import__("base64").b64decode(files[DIAG_RESULT_PATH]["content"]).decode())
    dp=json.loads(__import__("base64").b64decode(files[DIAG_PREFLIGHT_PATH]["content"]).decode())
    checks={
      "contract_exists": True,
      "contract_status_not_authorized": contract.get("status")=="CONTRACT — SCIENTIFIC EXECUTION NOT AUTHORIZED",
      "runtime_spec_exists": True,
      ...
      "fixture_identity": contract["scientific_fixture"]["sha256"]=="dd45ae453b5a3d37b4faff34ed829e7aac52ce4ed5a7462bb3546c1a420c2eb9" and contract["scientific_fixture"]["git_blob"]=="3ff971544f98c8d810173493cd49d54c46070952",
