...
def main():
    ...
    checks={
      ...
      "no_value_reward_utility_performance": all(x not in st.lower() for x in ("no individual response is assigned a value score","must not consume or derive:\\n- reward;","- utility;","- value;","- performance;")),
      "causal_value_excluded": "does not test a causal relationship of the form Δt_acc → Δv" in st.lower(),
