...
def main(argv):
    ...
    executor2_canonical = executor2.replace("\r\n", "\n").replace("\r", "\n")
    executor2_blob_sha=hashlib.sha1(("blob "+str(len(executor2_canonical.encode("utf-8")))+"\0").encode()+executor2_canonical.encode("utf-8")).hexdigest()
